                          ...
                          <tbody>
                              <?php
                                ...
                                while ($row = mysqli_fetch_assoc($select_comments)) {
                                    ...
                                    echo "<tr><td>{$comment_id}</td> <td>{$comment_author}</td><td>{$comment_content}</td>";
                                    ...
                                    echo "<td>{$comment_email}</td><td>{$comment_status}</td>";
                                    ...
                                    if ($user_role == 'admin' || $user_id == $author_id) {
                                        echo "<td><a href='post_comments.php?approve=$comment_id&id=$cid'>Approve</a> </td>
                                    <td><a href='post_comments.php?unapprove=$comment_id&id=$cid'>Unapprove</a> </td><td><a href='post_comments.php?delete=$comment_id&id=$cid'>Delete</a> </td>";
                                    } else {
                                        echo "<td>Approve </td><td>Unapprove </td><td>Delete </td>";
                                    };
